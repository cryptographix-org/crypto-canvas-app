...
export class Header extends Panel {
  ...
  getTemplate() {
    return `
    <span class="logo"><img src="red/images/node-red.png" title=""> <span>CGX Canvas</span></span>
    <ul class="header-toolbar hide" style="display: block; float: left;">
    <li>
      <span class="exec-button-group button-group" style="margin-left: 120px; margin-right: 20px; color: #a0c0f0 !important; border: 1px solid #ddd; padding: 4px;">
        <a id="btn-restart" class="run-button" href="#">
          <span class="restart-button-content">
        ...
        <a id="btn-step" class="reset-button" href="#">
          <span class="step-button-content">
            <i class="fa fa-step-forward"></i>
            <span>Step</span>
          </span>
        </a>
        <a id="btn-stop" class="stop-button" href="#">
    ...
    <li><span class="button-group" style="width: 200px!important"><a>&nbsp;</a></span></li>
      ...
      <li><span class="deploy-button-group button-group"><a id="btn-deploy" class="deploy-button" href="#"><span class="deploy-button-content"><img id="btn-deploy-icon" src="red/images/deploy-full-o.png"> <span>Deploy</span></span><span class="deploy-button-spinner hide"><img src="red/images/spin.svg"></span></a>
        <a id="btn-deploy-options" data-toggle="dropdown" class="deploy-button" href="#"><i class="fa fa-caret-down"></i></a>
          <ul id="btn-deploy-options-submenu" class="dropdown-menu pull-right hide">
            <li><a id="deploymenu-item-full" tabindex="-1" href="#" class="active"><i class="fa fa-square pull-left"></i><i class="fa fa-check-square pull-left"></i><img src="red/images/deploy-full.png"> <span class="menu-label-container"><span class="menu-label">Full</span><span class="menu-sublabel">Deploys everything in the workspace</span></span></a></li>
            <li><a id="deploymenu-item-flow" tabindex="-1" href="#"><i class="fa fa-square pull-left"></i><i class="fa fa-check-square pull-left"></i><img src="red/images/deploy-flows.png"> <span class="menu-label-container"><span class="menu-label">Modified Flows</span><span class="menu-sublabel">Only deploys flows that contain changed nodes</span></span></a></li>
            <li><a id="deploymenu-item-node" tabindex="-1" href="#"><i class="fa fa-square pull-left"></i><i class="fa fa-check-square pull-left"></i><img src="red/images/deploy-nodes.png"> <span class="menu-label-container"><span class="menu-label">Modified Nodes</span><span class="menu-sublabel">Only deploys nodes that have changed</span></span></a></li>
          </ul>
          </span>
      </li>
